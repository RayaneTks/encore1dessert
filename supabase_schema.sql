...
create table desserts (
  ...
  name text not null,
  emoji text not null,
  sell_price_particulier numeric not null default 0,
  sell_price_pro numeric not null default 0,
...
create table history_entries (
  ...
  customer_type text not null default 'particulier' check (customer_type in ('particulier', 'pro')),
