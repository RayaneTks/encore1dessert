  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        aria-modal="true"
        aria-label={title}
        className="relative w-full max-w-[400px] bg-white rounded-t-3xl sm:rounded-3xl shadow-2xl overflow-hidden pb-[max(0.5rem,env(safe-area-inset-bottom))]"
      >
        <div className="p-6 border-b border-gourmand-border flex justify-between items-center">
          ...
          <button
            ...
            className="w-11 h-11 rounded-full bg-gourmand-bg flex items-center justify-center"
          >
            <X size={18} />
          </button>
        </div>
