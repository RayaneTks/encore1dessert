...
export const initialDesserts: Dessert[] = [
  {
    id: 'dessert-peanut-caramel', name: 'Tarte cacahuète caramel', emoji: '🥜', sellPrice: 44, servings: 8, notes: '', createdAt: '2026-04-01T00:00:00Z',
    components: [
  ...
  {
    id: 'dessert-milk-choc', name: 'Tarte chocolat lait', emoji: '🍫', sellPrice: 42, servings: 8, notes: '', createdAt: '2026-04-01T00:00:00Z',
    components: [
      { type: 'base', id: 'prep-shortcrust', quantity: 180 },
  ...
  {
    id: 'dessert-almond', name: 'Tarte amandine', emoji: '🍰', sellPrice: 38, servings: 8, notes: '', createdAt: '2026-04-01T00:00:00Z',
    components: [
      { type: 'base', id: 'prep-shortcrust', quantity: 180 },
